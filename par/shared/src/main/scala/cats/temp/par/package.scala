...
package object par extends NonEmptyParConversion {
  @deprecated("Use Cats Parallel Directly - Fixed by cats 2.0.0-RC2", since = "1.0.0-RC2")
...
private[temp] sealed abstract class NonEmptyParConversion {
  @deprecated("Use Cats NonEmptyParallel Directly - Fixed by cats 2.0.0-RC2", since = "1.0.0-RC2")
